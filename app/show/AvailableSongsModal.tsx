                        ...
                        >
                            <ThemedView
                                style={{
                                    ...
                                    borderRadius: 15,
                                    borderWidth: 1,
                                    borderColor: isSelected ? '#DA291C' : 'gray',
                                    justifyContent: 'center',
                                    alignItems: 'center',
                                    marginRight: 8,
                                }}
                            >
                                {isSelected && <ThemedText style={{
                                    fontSize: 10,
                                    lineHeight: 14,
                                    textAlign: 'center'
                                }}>{order}</ThemedText>}
                            </ThemedView>
                            <ThemedText>{item.title} ({item.artist})</ThemedText>
                        </TouchableOpacity>
                    );
                }}
            />
        ...
        >
            <Pressable
                ...
                <Pressable
                    ...
                    <ThemedText style={{ fontWeight: 'bold' }}>Pick songs for Part #{content?.partNumber}</ThemedText>
                    {renderContent()}
                    <ThemedView style={{
                        flexDirection: 'row',
                        gap: 8
